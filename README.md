...
- ideas taken for scaffold taken from [this](https://github.com/YUzhva/create-react-redux-app) github repo
...
## Main Dependencies that were added to the app
- redux
- react-redux
- redux-saga
- react-router-dom
...
- src
  ...
  - containers // react components with data fetching
    * ContainerName
      tests
      index.js // entry point for container
  - redux
    * reduxCategory
      constants/actions/reducer/sagas/selectors.js // required files for redux store control
    * root-reducer.js // connect other reducers here
    * root-sagas.js // connect other sagas here
```
